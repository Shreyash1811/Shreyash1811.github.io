...
- Because this will require you to put in hours to collect the image data
- and then take more hours to train the model with that data
...
### Face comparision:
Lets upload one more picture in the bucket and compare both the faces to check if it can point the similarity between them.
